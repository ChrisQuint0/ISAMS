        ...
        return (
            <div className="flex items-center justify-center min-h-screen bg-neutral-100">
                <div className="text-center">
                    <GraduationCap className="h-12 w-12 text-neutral-300 mx-auto mb-3" />
                    <p className="text-neutral-500 text-sm">Unable to load student data.</p>
                </div>
            </div>
        );
    }
            ...
            <div className={"border-t border-neutral-200 flex-shrink-0 " + (isCollapsed ? "px-2 py-3" : "p-3")}>
                {isCollapsed ? (
                    ...
                    <div className="space-y-3">
                        ...
                        <button onClick={onSignOut} className="w-full flex items-center justify-center gap-2 px-3 py-2.5 rounded-lg text-sm font-medium text-destructive-semantic bg-destructive-semantic/8 border border-destructive-semantic/20 hover:bg-destructive-semantic/15 hover:border-destructive-semantic/30 transition-all cursor-pointer">

    ...
    try {
      ...
      const mappedPaper = {
        ...
        adviser: data.adviser
          ? `${data.adviser.title ? data.adviser.title + ". " : ""}${data.adviser.first_name || ""} ${data.adviser.last_name || ""}${data.adviser.credentials ? ", " + data.adviser.credentials : ""}`.trim() ||
            "Unspecified"
          : "N/A",
    ...
    try {
      ...
      if (!response.ok) {
        if (response.status === 401) {
          throw new Error(
            "Download service is currently unavailable. Please contact support.",
          );
        } else {
  ...
  const handleDelete = async () => {
    try {
      ...
      addToast({
        ...
        description:
          "The research and its associated files have been permanently removed.",
        variant: "success",
      });
  ...
  return (
    <div className="flex flex-col min-h-screen w-full bg-white relative overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        />
        <div
          className="absolute top-[45%] -left-24 w-[320px] h-[320px] rounded-full"
          style={{
        ...
        />
        <div
          className="absolute top-[35%] right-[-60px] w-[360px] h-[360px] rounded-full"
          style={{
        ...
        />
        <div
          className="absolute -bottom-24 left-[30%] w-[400px] h-[400px] rounded-full"
          style={{
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap items-center gap-x-8 gap-y-4">
                <div className="space-y-1">
                  <p className="text-[10px] uppercase tracking-[0.2em] font-black text-[#008A45]/60 mb-1">
                    Lead Authors
                  </p>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-6">
              {paper.downloadUrl ? (
                <Button
                  ...
                  className={`h-11 px-8 rounded-lg font-bold shadow-lg shadow-[#008A45]/20 transition-all duration-300 gap-2 border-none ${
                    downloadSuccess
                ...
                <Button
                  disabled
                  className="h-11 px-8 rounded-lg bg-gray-100 text-gray-400 font-semibold gap-2 border-none cursor-not-allowed"
                >
                  <Download className="h-4 w-4" />
                  PDF Unavailable
                </Button>
        ...
        <div className="p-8 md:p-12">
          <div className="max-w-5xl mx-auto">
            <div className="bg-white/40 backdrop-blur-md rounded-2xl border border-white/80 p-8 md:p-10 shadow-sm">
              ...
              <div
                className="text-gray-600 leading-relaxed text-lg tracking-wide abstract-content"
                dangerouslySetInnerHTML={{
                  __html: paper.abstract || "No abstract provided.",
                }}
              />
            </div>
          </div>

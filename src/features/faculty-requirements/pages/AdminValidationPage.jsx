...
export default function AdminValidationPage() {
  ...
  const { 
    loading, queue, recentApprovals, stats, processAction, downloadFile, refresh 
  } = useAdminValidation();
  ...
  const handleApproveAll = async () => {
    ...
    // Ideally this should be a single bulk backend call, but looping works for now
    for (const item of queue) {
      await processAction(item.submission_id, 'APPROVE', 'Bulk Approval');
    }
    refresh();
  };

  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 text-left">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white tracking-tight">Violations</h1>
          <p className="text-sm text-slate-500 mt-1">Student compliance monitor and disciplinary records</p>
        </div>

...
export default function DashboardPage() {
  ...
  const allModules = [
    {
      id: "thesis",
      title: "Thesis / HTE Archiving",
      description: "Manage and archive thesis and HTE documents",
      icon: thesisIcon,
  ...
  const modules = isStudent(rbac)
    ? studentModules
    : allModules.filter((module) => rbac?.superadmin || rbac?.[module.id]);
      ...
      <footer className="relative z-10 border-t border-gray-100 bg-white/60">
        <div className="max-w-7xl mx-auto px-6 py-5">
          <p className="text-xs text-gray-400 text-center">
            ISAMS — Integrated Smart Academic Management System &nbsp;·&nbsp;
